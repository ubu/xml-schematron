# This Makefile is for the XML::Schematron extension to perl.
#
...
MAKE = make
FULLEXT = XML/Schematron
BASEEXT = Schematron
PARENT_NAME = XML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/XML/Schematron.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/XML/Schematron.pm \
...
PM_TO_BLIB = lib/XML/Schematron/XPath.pm \
	blib/lib/XML/Schematron/XPath.pm \
	lib/XML/Schematron/Test.pm \
	...
	lib/XML/Schematron/XSLTProcessor.pm \
	blib/lib/XML/Schematron/XSLTProcessor.pm \
	lib/XML/Schematron/LibXSLT.pm \
	blib/lib/XML/Schematron/LibXSLT.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/XML/Schematron/XPath.pm $(INST_MAN3DIR)/XML::Schematron::XPath.$(MAN3EXT) \
	  lib/XML/Schematron.pm $(INST_MAN3DIR)/XML::Schematron.$(MAN3EXT) \
	  lib/XML/Schematron/LibXSLT.pm $(INST_MAN3DIR)/XML::Schematron::LibXSLT.$(MAN3EXT) 
